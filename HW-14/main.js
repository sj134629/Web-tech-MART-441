...
function readQueryString(queryObject) {
   ...
   if (queryObject != null) {
      ...
      let tName = queryObject.ageName;
      let cName = queryObject.colorName;
      let aName = queryObject.animalName;
      if (fName != undefined && lName != undefined && tName != undefined  && cName != undefined && aName != undefined) {
         fullName = "Your Name :" + " " +fName + " " + lName + "<br>" + "Your Age :" + " " + tName + "<br>" + "Your favorite color :" + " " + cName + "<br>" + "Your favorite Animal :" + " " + aName;
         // change the file
         updateFile(fullName);
      }
